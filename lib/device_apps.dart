...
class DeviceApps {
  ...
  static Future<List<Object>> getInstalledApplications(
      {bool includeSystemApps: false,
      bool includeAppIcons: false,
      bool onlyAppsWithLaunchIntent: false}) async {
    try {
      var data = await _channel.invokeMethod('getInstalledApps', <String, bool>{
  ...
  static Future<List<Object>> getAppByApkFile(List<String> list) async {
    var data = await _channel.invokeMethod(
      'getAppByApkFiles',
      <String, dynamic>{'paths': list, 'include_app_icon': true},
    );
    return data;
  }
}
